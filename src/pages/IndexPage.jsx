        ...
        <>
                            ...
                            <div className="col-12 main1-bg-color pt-48"> {/*外框 控制欄數*/}
                                <div className="main1-content d-flex flex-column justify-content-center align-items-center row-gap-48 pb-20">           {/*內層外框*/}
                                    ...
                                    <div className="main1-btn">
                                            <a className="a-re mian-btn1-set-sm" href="oEstimate.html">
                                            開始製作
                                            </a>
                                    </div>
                                    <div className="main1-img-box">
                                        <img className="main1-img" src="../assets/images/main-frame-sm.png" alt="main-frame-sm" />
                                        <img className="main-corner-img" src="../assets/images/main-sm-corner.png" alt="main-sm-corner" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row">                         {/*外框 不動*/} 
                            <div className="col-6 "> {/*外框 控制欄數*/}
                                <div className="main1-content-L h-100 d-xl-flex flex-xl-column justify-content-xl-center align-items-xl-start">           {/*內層外框*/}
                                    ...
                                    <div className="main1-btn">
                                        <button className="mian-btn1-set-sm">
                                            <a className="a-re" href="oEstimate.html">
                                            開始製作
                                            </a>
                                        </button>
                                    </div>
            ...
            <div className="main2 container-out py-64 py-lg-160">
                            ...
                            <div className="col-12 mb-64 col-lg-4 mb-lg-0">
                                <div className="main2-card1 main2-card-set">
                                    <div className="main2-card1-img-box main2-card-img-box-set">
                                        <img src="../assets/images/index-mian2-img01.png" alt="index-mian2-img01" />
                                    </div>
                            ...
                            <div className="col-12 mb-64 col-lg-4 mb-lg-0">
                                <div className="main2-card2 main2-card-set">
                                    <div className="main2-card2-img-box main2-card-img-box-set">
                                        <img src="../assets/images/index-mian2-img02.png" alt="index-mian2-img02" />
                                    </div>
                            ...
                            <div className="col-12 col-lg-4 mb-lg-0">
                                <div className="main2-card3 main2-card-set">
                                    <div className="main2-card3-img-box main2-card-img-box-set">
                                        <img src="../assets/images/index-mian2-img03.png" alt="index-mian2-img03" />
                                    </div>
                                    <div className="main2-box d-flex justify-content-center">
                ...
                <div className="d-flex justify-content-center d-lg-none">
                    <button className="mian-btn1-set-sm text-center">
                        <a className="a-re" href="oEstimate.html">
                        開始製作
                        </a>
                    </button>
                            ...
                            <div className="main3-content">           {/*內層外框*/}
                                ...
                                <div className="main3-card">
                                    ...
                                    <div className="main3-card-item1 border-bottom-set mb-64">
                                        ...
                                        <img className="d-block mx-auto main3-img-set" src="../assets/images/index-mian3-sm-img01.png" alt="index-mian3-sm-img01" />
                                        </div>
                                    ...
                                    <div className="main3-card-item2 mb-64">
                                        <div className="main3-img-box pb-24 mx-auto">
                                        <img className="d-block mx-auto main3-img-set" src="../assets/images/index-mian3-sm-img02.png" alt="index-mian3-sm-img02" />
                                        </div>
                                        ...
                                        <button className="fw-bolder d-block mx-auto mian-btn1-set-sm">
                                            <a className="a-re" href="oEstimate.html">
                                            開始製作
                                            </a>
                                        </button>
                                    ...
                                    <div className="main3-card-item3 border-bottom-set">
                                        <div className="main3-img-box pb-24 mx-auto">
                                        <img className="d-block mx-auto main3-img-set" src="../assets/images/index-mian3-sm-img03.png" alt="index-mian3-sm-img03" />
                                        </div>
                                        <div className="main-text-box pb-24">
                                ...
                                <div className="main3-card">
                                    ...
                                    <div className="main3-card-item1 d-flex justify-content-lg-center align-items-lg-center mb-112 gap-148">
                                        <div className="main3-img-box">
                                            <img className="d-block mx-auto main3-img-set" src="../assets/images/index-mian3-img01.png" alt="index-mian3-img01" />
                                        </div>
                                    ...
                                    <div className="main3-card-item2 d-flex flex-row-reverse justify-content-lg-between align-items-lg-center mb-112 gap-148">
                                        <div className="main3-img-box">
                                            <img className="d-block mx-auto main3-img-set" src="../assets/images/index-mian3-img02.png" alt="index-mian3-img02" />
                                        </div>
                                        <div className="item2-content">
                                            ...
                                            <div className="main3-btn-box">
                                                <button className="fs-24 fw-bolder py-24 px-88 d-block mian-btn1-set-sm">
                                                <a className="a-re" href="oEstimate.html">
                                                    開始製作
                                                </a>
                                                </button>
                                    ...
                                    <div className="main3-card-item3 d-flex justify-content-lg-between align-items-lg-center gap-148">
                                        <div className="main3-img-box">
                                            <img className="d-block main3-img-set" src="../assets/images/index-mian3-img03.png" alt="index-mian3-img03" />
                                        </div>
                                        <div className="main-text-box border-bottom-set pt-32 pb-28">
                    ...
                    <div className="row gx-xxl-48">                                            {/*外框 不動*/}
                        ...
                        <div className="col-4 d-none d-lg-block"> {/*外框 控制欄數 lg用*/}
                            <div className="main4-content h-100 d-flex flex-column justify-content-lg-center">           {/*內層外框*/}
                                ...
                                <div className="main3-btn-box">
                                    <button className="fs-24 fw-bolder d-block mian-btn1-set">
                                    <a className="a-re" href="oEstimate.html">
                                        開始製作
                                    </a>
                                    </button>
                    ...
                    <div className="row justify-content-center gx-0">      {/*外框 不動*/}
                        <div className="col-xl-12"> {/*外框 控制欄數*/}
                            <div className="main5-content">     {/*內層外框*/}
                                ...
                                <div className="swiper mySwiper index-main5-mySwiper-set mb-50 mb-xxl-96"> {/*swiper為整個輪播插件的最外層 輪播整體的尺寸由此設定 mySwiper則是細項部份的設定*/}
                                    <div className="swiper-wrapper"> {/*swiper-wrapper為包住輪播圖片的容器*/}

                                        <div className="swiper-slide">{/*swiper-slide為輪播圖片容器*/}

                                            
                                            <div className="main5-card1-box main5-card-box-set mx-auto">
                                                <div className="main5-card1-img-box main5-card-img-box-set mx-auto">
                                                    <picture>
                                                        <source srcSet="../assets/images/index-mian5-img01.png" media="(min-width:1400px)" />
                                                        <img className="img-set" src="../assets/images/index-mian5-sm-img01.png" alt="index-mian5-sm-img01" />
                                                    </picture>
                                                </div>
                                                <div className="main5-card1-text main5-card-text-set pt-24 pb-32 px-32 mx-auto d-flex flex-column justify-content-between">
                                                    <div className="main5-card1-title main5-card-title-set d-flex flex-column mb-xxl-24">
                                                        <h5 className="fw-700 text-nautral-white">2024材料與應用展即將來臨</h5>
                                                    ...
                                                    <div className="main5-card1-text main5-card-con-set d-flex flex-column mb-auto mb-xxl-24">
                                                        ...
                                                        第十三屆材料與應用大展將於2024年10月20日盛大登場，聚焦前沿科技與創新應用，精彩不容錯過。
                                                        </p>
                                                    </div>
                                                    <button className="secondary-btn1-set d-flex d-lg-none mx-auto text-purple">
                                                        <a className="a-re d-lg-none d-flex align-items-center" href="https://www.imttaiwan.com/" target="_blank">
                                                        More
                                                    ...
                                                    <button className="secondary-btn1-set d-none d-lg-flex align-items-center ms-lg-auto">
                                                        <a className="a-re d-none d-lg-flex align-items-center" href="https://www.imttaiwan.com/" target="_blank">
                                                        閱讀更多
                                                        <span className="material-symbols-outlined sec-btn1-img-set">
                                                            chevron_right
                                                        </span>
                                        ...
                                        <div className="swiper-slide">
                                            ...
                                            <div className="main5-card2-box main5-card-box-set mx-auto">
                                                <div className="main5-card2-img-box main5-card-img-box-set mx-auto">
                                                    <picture>
                                                    <source srcSet="../assets/images/index-mian5-img02.png" media="(min-width:1400px)" />
                                                    <img className="img-set" src="../assets/images/index-mian5-sm-img02.png" alt="home-section2-1" />
                                                    </picture>
                                                </div>
                                                <div className="main5-card2-text main5-card-text-set pt-24 pb-32 px-32 mx-auto d-flex flex-column justify-content-between">
                                                    <div className="main5-card2-title main5-card-title-set d-flex flex-column mb-xxl-24">
                                                        <h5 className="fw-700 text-nautral-white">Come&Buy榮獲藍點設計獎</h5>
                                                        <time className="fw-500 text-primary3" dateTime="2024/07/07">2024/07/07</time>
                                                    </div>
                                                    <div className="main5-card2-text main5-card-con-set d-flex flex-column mb-auto mb-xxl-24">
                                                        <p className="fw-500 text-nautral-white">
                                                        好消息！恭喜Come&Buy榮獲藍點設計獎，這一殊榮肯定了我們在3D列印與創新設計領域的卓越表現。
                                                        </p>
                                                    </div>
                                                    <button className="secondary-btn1-set d-flex align-items-center mx-auto d-lg-none text-purple">
                                                        <a className="a-re d-lg-none d-flex align-items-center" href="https://www.imttaiwan.com/" target="_blank">
                                                        More
                                                        <span className="material-symbols-outlined sec-btn1-img-set">
                                                            chevron_right
                                        ...
                                        <div className="swiper-slide">
                                            ...
                                            <div className="main5-card3-box main5-card-box-set mx-auto">
                                                <div className="main5-card3-img-box main5-card-img-box-set mx-auto">
                                                    <picture>
                                                    <source srcSet="../assets/images/index-mian5-img03.png" media="(min-width:1400px)" />
                                                    <img className="img-set" src="../assets/images/index-mian5-sm-img03.png" alt="home-section2-1" />
                                                    </picture>
                                                </div>
                                                <div className="main5-card3-text main5-card-text-set pt-24 pb-32 px-32 mx-auto d-flex flex-column justify-content-between">
                                                    <div className="main5-card3-title main5-card-title-set d-flex flex-column mb-xxl-24">
                                                        <h5 className="fw-700 text-nautral-white mb-28 mb-xxl-0">新材料現世！！！</h5>
                                                        <time className="fw-500 text-primary3" dateTime="2024/04/01">2024/07/30</time>
                                                    </div>
                                                    <div className="main5-card3-text main5-card-con-set d-flex flex-column mb-auto mb-xxl-24">
                                                        <p className="fw-500 text-nautral-white">
                                                        德國杜瓦實驗室發表最新型奈米級技術,將在材料科學與應用領域帶來突破性進展。
                                                        </p>
                                                    </div>
                                                    <button className="secondary-btn1-set d-flex align-items-center mx-auto d-lg-none text-purple">
                                                        <a className="a-re d-lg-none d-flex align-items-center" href="https://www.imttaiwan.com/" target="_blank">
                                        ...
                                        <div className="swiper-slide">
                                            ...
                                            <div className="main5-card3-box main5-card-box-set mx-auto h-100">
                                                <div className="main5-card3-img-box main5-card-img-box-set mx-auto">
                                                    <picture>
                                                    <source srcSet="../assets/images/index-mian5-img03.png" media="(min-width:1400px)" />
                                                    <img className="img-set" src="../assets/images/index-mian5-sm-img03.png" alt="home-section2-1" />
                                ...
                                <div className="main5-btn-box text-center">
                                    <button className="mian-btn1-set-sm">
                                    <a className="a-re" href="https://www.imttaiwan.com/" target="_blank">
                                        更多消息
                                    </a>
                                    </button>
                                </div>
                                <div className="swiper-next-R-btn">
                                <button className="carousel-btn-R">
                                    <div className="img-box">
                                        <img className="img-set" src="../assets/images/index-main5-arrowR.png" alt="index-main5-arrowR" />
                                    </div>
                                </button>
                                </div>
                                ...
                                <button className="carousel-btn-L">
                                    <div className="img-box">
                                        <img className="img-set" src="../assets/images/index-main5-arrowL.png" alt="index-main5-arrowL" />
                                    </div>
                                </button>
                                </div>
                            </div>
